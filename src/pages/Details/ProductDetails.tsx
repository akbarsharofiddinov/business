...
import product from "@/assets/images/catalog.png";
      ...
      <section className="section-product-details">
        <div className="container">
          <div className="paths">
            ...
            <span>/</span>
            <a href="#">Ichki eshiklar</a>
            <span>/</span>
            <a href="#">Model № 12</a>
          </div>
          <div className="section-inner">
            <div className="section-title">
              <h3 className="title">Model № 12</h3>
            </div>
            <div className="product-info_box">
              ...
              <div className="info">
                <p className="desc">
                  Ichki eshiklar - bu bo'shliqni funktsional zonalarga
                  ajratadigan xonaning bir turi. Ammo bu funktsiyani bajarishdan
                  tashqari, ular ham muhim dekorativ element bo'lib xizmat
                  qiladi. Shuning uchun tuval uyg'unlikni buzmaslik uchun ichki
                  makonning umumiy uslubiga qarab tanlanishi kerak.
                </p>
                <div className="ordering_and_price">
                  ...
                  <button className="order-btn" onClick={() => setModal(true)}>
                    Buyurtma berish
                  </button>
                </div>
              </div>
